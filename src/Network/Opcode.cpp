...
void initOpcode()
{
    opcodeTable[OP_KEEPALIVE] = OpcodeHandler("KEEP_ALIVE", STATE_EVERYTIME, &NetworkSession::handleKeepAlive, false, 4);
    ...
    opcodeTable[OP_USE_ENTITY] = OpcodeHandler("USE_ENTITY", STATE_INGAME, &NetworkSession::handleUseEntity, 9);
    opcodeTable[OP_PLAYER] = OpcodeHandler("PLAYER", STATE_INGAME, &NetworkSession::handlePlayer, false, 1);
    opcodeTable[OP_PLAYER_POSITION] = OpcodeHandler("PLAYER_POSITION", STATE_INGAME, &NetworkSession::handlePlayerPosition, false, 33);
    opcodeTable[OP_PLAYER_LOOK] = OpcodeHandler("PLAYER_LOOK", STATE_INGAME, &NetworkSession::handlePlayerLook, false, 9);
    opcodeTable[OP_PLAYER_POSITION_AND_LOOK] = OpcodeHandler("POSITION_AND_LOOK", STATE_INGAME, &NetworkSession::handlePlayerPositionAndLook, false, 41);
    opcodeTable[OP_PLAYER_DIGGING] = OpcodeHandler("PLAYER_DIGGING", STATE_INGAME, &NetworkSession::handlePlayerDigging, 11);
    ...
    opcodeTable[OP_HELD_ITEM_CHANGE] = OpcodeHandler("HELD_ITEM_CHANGE", STATE_INGAME, &NetworkSession::handleHeldItemChange, 2);
    opcodeTable[OP_ANIMATION] = OpcodeHandler("ANIMATION", STATE_INGAME, &NetworkSession::handleAnimation, 5);
    opcodeTable[OP_ENTITY_ACTION] = OpcodeHandler("ENTITY_ACTION", STATE_INGAME, &NetworkSession::handleEntityAction, 5);
    opcodeTable[OP_CLOSE_WINDOW] = OpcodeHandler("CLOSE_WINDOW", STATE_INGAME, &NetworkSession::handleCloseWindow, 1);
    opcodeTable[OP_CLICK_WINDOW] = OpcodeHandler("CLICK_WINDOW", STATE_INGAME, &NetworkSession::handleClickWindow);
    opcodeTable[OP_CONFIRM_TRANSACTION] = OpcodeHandler("CONFIRM_TRANSACTION", STATE_INGAME, &NetworkSession::handleConfirmTransaction, 4);
    ...
    opcodeTable[OP_ENCHANT_ITEM] = OpcodeHandler("ENCHANT_ITEM", STATE_INGAME, &NetworkSession::handleEnchantItem, 2);
    ...
    opcodeTable[OP_CLIENT_STATUSES] = OpcodeHandler("CLIENT_STATUSES", (STATE_INGAME | STATE_LOGGING), &NetworkSession::handleClientStatuses, 1);
